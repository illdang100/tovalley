...
class ChatServiceImplTest extends DummyObject {
    ...
    public void createOrGetChatRoom_return_test() {
        ...
        when(chatRoomRepository.findByMemberIdAndOtherMemberNickname(senderId, reqDto.getRecipientNick()))
    ...
    public void createOrGetChatRoom_create_test() {
        ...
        when(chatRoomRepository.findByMemberIdAndOtherMemberNickname(senderId, recipientNick))
