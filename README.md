...
#### ✔️ 소셜 로그인
- 카카오, 네이버, 구글을 통해 소셜 로그인을 할 수 있다.

#### ✔️ 주변 의료시설 정보 기능

#### ✔️ 수질 및 수심, 구조 용품과 안전사고 현황 제공 기능
...
#### ✔️ 관리자 기능
웹 사이트의 관리자는 각 물놀이 장소의 정보를 조회하고, 해당 장소에서 발생한 사건·사고를 등록 및 삭제할 수 있는 권한을 가지고 있습니다. </br>
또한 물놀이 장소의 대표 이미지 및 상세 정보 그리고 구조 용품 현황 등을 수정할 수 있습니다. </br>
